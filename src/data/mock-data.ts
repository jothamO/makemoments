...
export const mockEvents: CelebrationEvent[] = [
  ...
  },
  {
    ...
    name: "Mother's Day",
    slug: "mothers-day",
    date: new Date("2026-05-10").getTime(),
    launchDate: new Date("2026-04-20").getTime(),
    ...
    theme: {
      ...
      bgGradientEnd: "#FFE66D",
      textDark: "#2D3436",
      textLight: "#FFFFFF",
      headlineFont: "Playfair Display",
      bodyFont: "Montserrat",
      backgroundPattern: "hearts",
      headline: "Honor Your Hero",
      subheadline: "Show mom she's loved. Starting at just ₦1,000.",
      ctaText: "Celebrate Mom",
      urgencyText: "✨ Mother's Day is May 10th",
    },
    createdAt: Date.now(),
  },
  {
    ...
    name: "Father's Day",
    slug: "fathers-day",
    date: new Date("2026-06-21").getTime(),
    launchDate: new Date("2026-06-01").getTime(),
    endDate: new Date("2026-06-25").getTime(),
    status: "upcoming",
    theme: {
      primary: "#1A5F7A",
      secondary: "#159895",
      accent: "#00DFA2",
      bgGradientStart: "#1A5F7A",
      bgGradientEnd: "#159895",
      textDark: "#002B5B",
      textLight: "#FFFFFF",
      headlineFont: "Montserrat",
      bodyFont: "Inter",
      backgroundPattern: "geometric",
      headline: "To the World's Best Dad",
      subheadline: "A gift he'll treasure forever. Just ₦1,000.",
      ctaText: "Celebrate Dad",
      urgencyText: "✨ Father's Day is June 21st",
    },
    createdAt: Date.now(),
  },
];
